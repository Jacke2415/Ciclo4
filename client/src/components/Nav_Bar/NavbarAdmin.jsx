        ...
        return (
            <>
                <nav class="main-menu">
                    <ul>
                        <li>
                            <Link to='/singin/administrador/perfilAdministrador'>
                        ...
                        <li className="has-subnav">
                            <Link to='/singin/administrador/gestionarEmpleado'>
                        ...
                        <li className="has-subnav">
                            <Link to='/singin/administrador/gestionarNomina'>
                        ...
                        <li>
                            <Link to='/singin/administrador/gestionarVacaciones'>
                        ...
                        <li>
                            <Link to='/singin/administrador/gestionarPermisos'>
                        ...
                        <li>
                            <Link to='/singin/administrador/generarReportes'>
