          ...
          <ul>
            ...
            <li className="has-subnav">
              <a href="#">
                ...
                <span className="nav-text">Solicitar Permisos</span>
              </a>
            </li>
            <li className="has-subnav">
              <a href="#">
                ...
                <span className="nav-text">Solicitar Vacaciones</span>
              </a>
            </li>
            <li>
              <a href="#">
                ...
                <span className="nav-text">Certificados Laborales</span>
              </a>
            </li>
            <li>
              <a href="#">
                ...
                <span className="nav-text">Solicitar Reportes de Pago</span>
              </a>
            </li>
          </ul>
          <ul className="logout">
